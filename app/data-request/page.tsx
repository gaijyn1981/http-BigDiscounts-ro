    ...
    <main className="min-h-screen" style={{background: '#0a0a0a'}}>
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="rounded-2xl p-8" style={{background: '#111111', border: '1px solid #222'}}>
          <h1 className="text-3xl font-black text-white mb-2">Solicitare Date</h1>
          <p className="text-gray-500 mb-8">Exercită-ți drepturile GDPR UK. Vom răspunde în 30 de zile.</p>
          {submitted ? (
            <div className="text-center py-8">
              <div className="text-5xl mb-4">✅</div>
              <h2 className="text-2xl font-black text-white mb-2">Solicitare Trimisă!</h2>
              <p className="text-gray-500">Vom răspunde în 30 de zile.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-gray-400 mb-1">Numele Complet</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-400 mb-1">Tipul Solicitării</label>
                <select name="type" value={form.type} onChange={update} required
                  className="w-full px-4 py-3 rounded-xl text-white focus:outline-none"
                  style={{background: '#1a1a1a', border: '1px solid #333'}}>
                  <option value="">Selectează</option>
                  <option value="Access my data">Accesează datele mele</option>
                  <option value="Delete my data">Șterge datele mele</option>
                  <option value="Correct my data">Corectează datele mele</option>
                  <option value="Export my data">Exportă datele mele</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-400 mb-1">Detalii Suplimentare</label>
