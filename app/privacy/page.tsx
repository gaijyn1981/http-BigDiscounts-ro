        ...
        <div className="rounded-2xl p-8" style={{background: '#111111', border: '1px solid #222'}}>
          ...
          <div className="space-y-6 text-gray-400 leading-relaxed">
            <section>
              ...
              <p>BigDiscounts este operat de Petrica Marin, un comerciant individual din Gloucester, UK. Contact: hello@bigdiscounts.uk</p>
            </section>
            <section>
            ...
            <section>
              ...
              <p>Prelucrăm datele tale în baza: executării contractului (pentru a furniza serviciul nostru), interesului legitim (pentru a îmbunătăți platforma) și obligației legale (conformitate UK GDPR).</p>
            </section>
            <section>
            ...
            <section>
              ...
              <p>Conform UK GDPR ai dreptul de a accesa, corecta, șterge sau exporta datele tale. Trimite o solicitare pe <Link href="/data-request" style={{color: '#fcd968'}} className="hover:opacity-80">pagina noastră de solicitare date</Link>.</p>
            </section>
            <section>
